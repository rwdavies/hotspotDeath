...
```
## Loss AT to GC, CHIMP, L1M5, motifNumber = 2
```

![plot of chunk motifPValues](figure/motifPValues2.png) 

```
## Loss AT to GC, CHIMP, L1M5, motifNumber = 3
```
...
```
## Loss AT to GC, CHIMP, L1MB2, motifNumber = 1
```
...
```
## Loss AT to GC, CHIMP, L1MB7, motifNumber = 2
```
...
```
## Loss AT to GC, CHIMP, L1PA11, motifNumber = 1
```
...
```
## Loss AT to GC, CHIMP, L1PA15, motifNumber = 2
```
...
```
## Loss AT to GC, CHIMP, L2, motifNumber = 1
```
...
```
## Loss AT to GC, CHIMP, L2a, motifNumber = 5
```
...
```
## Loss AT to GC, CHIMP, MIRb, motifNumber = 3
```
...
```
## Loss AT to GC, CHIMP, MLT1C, motifNumber = 2
```
...
```
## Loss AT to GC, CHIMP, THE1C, motifNumber = 1
```

![plot of chunk motifPValues](figure/motifPValues105.png) 

```
## Loss AT to GC, CHIMP, Tigger1, motifNumber = 1
```
